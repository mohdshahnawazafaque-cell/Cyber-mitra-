        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 pb-4 border-b border-slate-200">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-black text-slate-900">
                {isHindi ? 'हमारे बारे में (About CYBER MITRA)' : 'About CYBER MITRA'}
              </h1>
          ...
          <div className="text-sm text-slate-700 leading-relaxed space-y-3">
            {isHindi ? (
              <>
                <p>
                  <strong>CYBER MITRA</strong> भारत भर के साइबर कैफे, सीएससी (CSC) और जन सेवा केंद्र (Jan Seva Kendra) संचालकों के दैनिक कार्यों को तेज, सुगम और त्रुटिहीन बनाने के उद्देश्य से विकसित किया गया एक आधुनिक वर्क पोर्टल है।
                </p>
                <p>
              ...
              <>
                <p>
                  <strong>CYBER MITRA</strong> is an all-in-one productivity and citizen service navigation platform built specifically for Cyber Cafe, CSC (Common Service Center), and Jan Seva Kendra operators across India.
                </p>
                <p>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 pb-4 border-b border-slate-200">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                {isHindi ? 'सुझाव, सहायता या पोर्टल संबंधी प्रश्नों के लिए संपर्क करें' : 'Get in touch with the Cyber Mitra team for inquiries & support'}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-slate-700">
            <div className="space-y-3">
              ...
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2 text-xs">
                ...
                <p><strong>{isHindi ? 'ईमेल (Official Email):' : 'Official Email:'}</strong> mohdshahnawaz.afaque@gmail.com</p>
        ...
        <div className="space-y-4 text-sm text-slate-700 leading-relaxed">
          ...
          {isHindi ? (
            <>
              ...
              <p>
                CYBER MITRA पोर्टल पर प्रोसेस की जाने वाली सभी तस्वीरें, हस्ताक्षर, पीडीएफ और ग्राहक जानकारी आपके ब्राउज़र के भीतर (Client-side HTML5 Canvas/JS) ही प्रोसेस होती हैं। हम आपके ग्राहकों के आधार कार्ड, फोटो या व्यक्तिगत पहचान दस्तावेजों को अपने किसी भी केंद्रीय सर्वर पर अपलोड या संग्रहीत (Store) नहीं करते हैं।
              </p>
            ...
            <>
              ...
              <p>
                All image resizing, KB compression, signature enhancement, PDF compilation, and customer forms processed on CYBER MITRA run strictly client-side inside your browser environment (HTML5 Canvas / Web APIs). We do not upload, transmit, or store your customers' Aadhaar cards, personal photos, or sensitive identity documents on any central server.
              </p>
      ...
      {view === 'terms' && (
        <div className="space-y-4 text-sm text-slate-700 leading-relaxed">
          ...
          {isHindi ? (
            <>
              <p>
                CYBER MITRA पोर्टल का उपयोग करते समय आप निम्नलिखित नियमों का पालन करने के लिए सहमत होते हैं:
              </p>
            ...
            <>
              <p>
                By using the CYBER MITRA platform, you agree to comply with the following terms:
              </p>
              <ul className="list-disc pl-5 space-y-2 text-xs text-slate-600">
      ...
      {view === 'disclaimer' && (
        <div className="space-y-4 text-sm text-slate-700 leading-relaxed">
          ...
          <div className="p-4 bg-amber-50 rounded-xl border border-amber-200 text-amber-900 text-xs sm:text-sm font-semibold space-y-2">
            <p>
              ⚠️ <strong>{isHindi ? 'CYBER MITRA कोई सरकारी वेबसाइट या सरकारी विभाग नहीं है।' : 'CYBER MITRA is NOT an official government website or government agency.'}</strong>
            </p>
            <p>
              {isHindi
